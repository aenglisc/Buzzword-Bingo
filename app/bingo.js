...
var _user$project$Score$encodeScore = F2(
				...
				_1: {
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$int(
							_user$project$Entry$sumMarkedPoints(entries))
					},
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Score$viewScore = function (sum) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Score$scoreDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Score$Score,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'score', _elm_lang$core$Json_Decode$int));
var _user$project$Score$postScore = F3(
	function (msg, name, entries) {
		var body = _elm_lang$http$Http$jsonBody(
			A2(_user$project$Score$encodeScore, name, entries));
		var url = 'http://localhost:3000/scores';
		var request = A3(_elm_lang$http$Http$post, url, body, _user$project$Score$scoreDecoder);
...
var _user$project$Bingo$hasZeroScore = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		...
		switch (_p3.ctor) {
			...
			case 'ShareScore':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$Score$postScore, _user$project$Bingo$NewScore, model.name, model.entries)
				};
			case 'NewScore':
				if (_p3._0.ctor === 'Ok') {
					var message = A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p3._0._0.score),
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								alertMessage: _elm_lang$core$Maybe$Just(
									_user$project$Bingo$httpErrorToMessage(_p3._0._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							entries: A2(_user$project$Entry$markEntryWithId, model.entries, _p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Bingo$init = {ctor: '_Tuple2', _0: _user$project$Bingo$initialModel, _1: _user$project$Bingo$getEntries};
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$Score$viewScore(
									_user$project$Entry$sumMarkedPoints(model.entries)),
								_1: {
									ctor: '::',
									_0: A2(
														...
														_1: {
															...
															_1: {
																...
																_0: _elm_lang$html$Html_Attributes$disabled(
																	_user$project$Bingo$hasZeroScore(model)),
																_1: {ctor: '[]'}
															}
														}
													},
